...
/**
 * Create an OAuth2 client with the given credentials, then execute the given
 * callback function.
...
function listMajors(auth) {
  ...
  sheets.spreadsheets.values.get({
    spreadsheetId: '1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms', // '1mE6cYbBlaOEB_BZDVHwWEElHCu8dVsEGcNwajPrcbnU'
    ...
    if (rows.length) {
      ...
      // Pring columns A and E, which correspond to indices 0 and 4
